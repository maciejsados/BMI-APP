...
public class BMI_ViewBinding implements Unbinder {
  private BMI target;

  @UiThread
  public BMI_ViewBinding(BMI target, View source) {
    this.target = target;
    ...
    target.button = Utils.findRequiredViewAsType(source, R.id.btn, "field 'button'", Button.class);
  }
